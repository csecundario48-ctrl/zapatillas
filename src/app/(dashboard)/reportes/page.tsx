      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
        {kpis.map(k => (
          <div key={k.label} className={`${card} p-5`}>
            <p className="text-xs text-foreground/55 uppercase tracking-wider mb-2">{k.label}</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-foreground/[0.06] bg-background">
                    <th className="text-left px-4 py-3 text-xs text-foreground/45 uppercase tracking-wider">#</th>
                    <th className="text-left px-4 py-3 text-xs text-foreground/45 uppercase tracking-wider">Marca</th>
                    <th className="text-right px-4 py-3 text-xs text-foreground/45 uppercase tracking-wider">Unidades</th>
                  </tr>
                </thead>
                <tbody>
                  {brandData.map((b, i) => (
