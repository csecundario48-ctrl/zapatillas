            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-foreground/[0.06] bg-card">
                  <th className="text-left px-4 py-3 text-xs text-foreground/55 uppercase tracking-wider font-medium">Cliente</th>
                  ...
                  <th className="text-right px-4 py-3 text-xs text-foreground/55 uppercase tracking-wider font-medium">Gasto total</th>
                  <th className="text-left px-4 py-3 text-xs text-foreground/55 uppercase tracking-wider font-medium">Última</th>
              ...
              <tbody>
                {filtered.map(r => (
                  <tr key={r.id} className="border-b border-foreground/[0.05] hover:bg-foreground/[0.02] transition-colors">
                    ...
                    <td className="px-4 py-3 text-right font-semibold text-foreground">{formatCurrency(r.totalSpent)}</td>
