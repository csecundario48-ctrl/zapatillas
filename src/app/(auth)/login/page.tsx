        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              <label htmlFor="email" className="font-mono text-[10px] font-medium text-foreground/60 uppercase tracking-[0.14em]">
                Email
              </label>
              <input
                id="email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="password" className="font-mono text-[10px] font-medium text-foreground/60 uppercase tracking-[0.14em]">
                Contraseña
              </label>
              <input
                id="password"
