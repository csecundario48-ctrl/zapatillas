  ...
  return (
    <div className="inline-flex items-center gap-1">
      <button
        ...
        disabled={loading}
        onClick={handle}
        className="px-2 py-1 rounded-md text-[11px] font-medium text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/15 disabled:opacity-50 transition-colors"
      >
        {loading ? '...' : 'Borrar'}
      </button>
      <button
